	...
	public static void main(String[] args) {
		...
		*/		
		...
		/*		
				...
				[2-6] 다음 중 키워드가 아닌 것은?(모두 고르시오) c, e
				a. if
				b. True
				c. NULL
				d. Class
				...
				[2-7] 다음 중 변수의 이름으로 사용할 수 있는 것은? (모두 고르시오) e , f
				a. $ystem
				b. channel#5
				c. 7eleven
				d. If
				...
				[2-9] 다음 중 형변환을 생략할 수 있는 것은? (모두 고르시오) b,c,e
				byte b = 10;
				char ch = 'A';
				int i = 100;
				long l = 1000L;
				...
				[2-11] 다음중 변수를 잘못 초기화 한 것은? (모두 고르시오)a, c, e
				a. byte b = 256;
				b. char c = '';
				c. char answer = 'no';
				d. float f = 3.14
				...
				[2-13] 다음 중 타입과 기본값이 잘못 연결된 것은? (모두 고르시오) f
				a. boolean - false
				b. char - '\u0000'
				c. float - 0.0
				d. int - 0
